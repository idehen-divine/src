<section class="pb-10 mb-4" style="margin-top: 100px;">
    ...
    <div class="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-14 py-6">
        <!-- Tier 1 Plan -->
        <div class="border border-zinc-300 rounded-lg p-6 text-center flex flex-col h-full">
            ...
            <a href="{{ route('checkins') }}" class="btn bg-orange-500 hover:bg-orange-400 border-none text-white mt-10">INVEST</a>
        </div>

        <!-- Tier 2 Plan -->
        <div class="bg-orange-500 rounded-lg p-6 text-white text-center flex flex-col h-full relative">
            <span class="absolute top-0 right-0 text-yellow-500 bg-white px-2 py-1 text-xs font-bold rounded-bl-lg">MOST
                POPULAR</span>
            ...
            <a href="{{ route('checkins') }}" class="btn bg-white hover:bg-gray-100 border-none text-orange-500 mt-10">INVEST</a>
        </div>
    </div>
</section>
