                ...
                <div class="gap-10">
                    ...
                    <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-500">Our friendly team is here to help.
                            </p>
                            <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">
                                <a href="mailto:{{ settings()->getValue('app_email', '') }}">{{ settings()->getValue('app_email', 'NA') }}</a>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-500">Contact now</p>
                            <p class="mt-2 text-sm text-blue-500 dark:text-blue-400 font-bold">
                                <a href="tel:+234{{ settings()->getValue('app_phone', 'NA') }}">+(234) {{ settings()->getValue('app_phone', 'NA') }}</a>
                            </p>
                        </div>
                    </div>
                </div>
