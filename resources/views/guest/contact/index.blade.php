    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container mt-20 px-6 py-12 mx-auto">
            <div>
                ...
                <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Chat to our friendly
                    team</h1>
                ...
                <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">
                            {{ settings()->getValue('app_email', 'NA') }}</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Contact now</p>
                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400 font-bold">
                            {{ settings()->getValue('app_phone', 'NA') }}</p>
                    </div>
                </div>
